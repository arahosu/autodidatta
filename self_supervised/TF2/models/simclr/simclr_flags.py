...
flags.DEFINE_enum('optimizer', 'adam', ['lamb', 'adam', 'sgd', 'adamw'], 'lamb (default), adam')
...
flags.DEFINE_string('logdir', 'gs://cifar10_baseline/checkpoints/', 'Directory for where the weights are being saved')
